# ============================================================================
# Fed Split learning: ResNet18 on chest_xray
# ============================================================================
import torch
...
num_users = 5
epochs = 200
frac = 1  # participation of clients; if 1 then 100% clients participate in PSL
lr = 0.0001
...
def train_server(fx_client, y, l_epoch_count, l_epoch, idx, len_batch):
    ...
    if count1 == len_batch:
        ...
        print("l_epoch_count= ", l_epoch_count)
        print("l_epoch= ", l_epoch)
        ...
        if len(idx_collect) == num_users:
            ...
            # print("acc_avg_all_user_train = ", acc_avg_all_user_train)
            # print("len(acc_train_collect_user) = ", len(acc_train_collect_user))
    ...
    with torch.no_grad():
        ...
        if count2 == len_batch:
            ...
            if fed_check:
                fed_check = False
                print("------------------------------------------------")
                print("------- FedAVG process at Server-Side --------- ")
                print("------------------------------------------------")
...
for iter in range(epochs):
    ...
    # Server: Federation process at Client-Side-----------
    print("-----------------------------------------------------------")
    print("------ LocalModelAVG: Federation process at Client-Side ------- ")
    print("-----------------------------------------------------------")
