...
% load data
load('OCT_loss_iid.mat')
% Baseline 1: CL
data_1 = OCT_loss_iid(:,1);
% Baseline 2: FL
data_2 = OCT_loss_iid(:,2);
% Sequential FedSL
data_3 = OCT_loss_iid(:,3);
% Parallel FedSL
data_4 = OCT_loss_iid(:,4);
...
title('OCT Images: IID','FontWeight','normal')
...
axes('position',[0.51,0.55,0.37,0.35]);
