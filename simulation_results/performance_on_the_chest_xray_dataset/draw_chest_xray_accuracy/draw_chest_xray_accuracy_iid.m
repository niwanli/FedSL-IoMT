...
% load data
load('chest_xray_accuracy_iid.mat')
% Baseline 1: CL
data_1 = chest_xray_accuracy_iid(:,1);
% Baseline 2: FL
data_2 = chest_xray_accuracy_iid(:,2);
% Sequential FedSL
data_3 = chest_xray_accuracy_iid(:,3);
% Parallel FedSL
data_4 = chest_xray_accuracy_iid(:,4);
