...
% load data
load('chest_xray_loss_non_iid.mat')
% Baseline 1: CL
data_1 = chest_xray_loss_non_iid(:,1);
% Baseline 2: FL
data_2 = chest_xray_loss_non_iid(:,2);
% Sequential FedSL
data_3 = chest_xray_loss_non_iid(:,3);
% Parallel FedSL
data_4 = chest_xray_loss_non_iid(:,4);
